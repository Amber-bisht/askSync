...
UserSchema.methods.upgradeToPaid = async function (subscriptionEndDate: Date) {
  ...
  // Reset secondary/legacy counters just in case they are used elsewhere
  this.monthlyTestsUsed = 0;
  this.monthlyFormsUsed = 0;
  this.monthlyAccessListsUsed = 0;
  this.monthlyAiGradingUsed = 0;
  this.monthlyMcqUsed = 0;
  this.monthlyQaUsed = 0;
